...
namespace AutoRespect.Infrastructure.Api.Design
{
    ...
    */
    ...
    {
        Task<R<TResponse>> Get<TResponse>(string uri);
        Task<R<TResponse>> Post<TBody, TResponse>(string uri, TBody body);
        Task<R<TResponse>> Put<TBody, TResponse>(string uri, TBody body);
        Task<R<TResponse>> Delete<TResponse>(string uri);
    }
}
